...
const { logoutCtrl, loginCtrl, registerCtrl } = require("../../controllers/authControllers");
const {
  currentUserCtrl,
  userStatusCtrl,
...
const { registertSchema, loginSchema } = require("./middleware/schemes/userValidSchema");
